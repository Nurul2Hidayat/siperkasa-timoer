...
<html class="fixed">
	<head>
		...
		<title>Laporan kegiatan SIMRS</title>
	...
	<body>
		...
		<section class="panel">
			<header class="panel-heading">
				...
				?>
				<h2 class="panel-title" align="center">LAPORAN KEGIATAN SIMRS</h2>
				...
				<table class="table table-bordered table-striped mb-none">
					...
					<tbody>
						<tr class="gradeX">
							...
							<td width="300"><?php echo $rows_isi["kegiatan"];?></td>			
							<td width="300"><?php echo $rows_isi["lokasi"];?></td>			
							...
							<td class="center" width="100"><?php echo $rows_isi["tgl_selesai"];?></td>
							<td width="300"><?php echo $rows_isi["hasil"];?></td>
						</tr>
						<?php
						}	
						?>
