...
<script>
	...
	function get_data(){
		$.ajax({
            url: 'master/jenis_data.php?f=get_data',
            type: 'POST',
			dataType: 'json',
	...
	function edit_data(id){
		$.ajax({
			url		: 'master/jenis_data.php?f=get_data_edit',
			type	: 'POST',
			data	: {'gid':id},
			dataType: 'json',
			success	: function(data){
				$('#g_id_edit').val(data.jenis_id);
				$('#g_nama_edit').val(data.nm_jenis);
	...
	function add_data(){
		...
		$.ajax({
			url		: 'master/jenis_data.php?f=add_data',
			type	: 'POST',
			data	: formData,
			dataType: 'json',
			processData: false,
	...
	function edit_data_proses(){
		...
		$.ajax({
			url		: 'master/jenis_data.php?f=edit_data_proses',
			type	: 'POST',
			data	: formData,
			dataType: 'json',
			processData: false,
	...
	function hapus_data(id){
		...
		if(cc == true){
			$.ajax({
				url		: 'master/jenis_data.php?f=hapus_data&gid='+id,
				type	: 'get',
				contentType	: false,
				processData : false,
				success	: function(){
